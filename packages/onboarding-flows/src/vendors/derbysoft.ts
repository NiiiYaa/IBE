...
const DERBYSOFT_PMS_ID = 46;

// DerbySoft onboarding flow — no KB article found; built as Switch stub.
// kbVerified: false — verify property ID format, contact details, and connection steps with DerbySoft before production use.
// DerbySoft is a distribution Switch that connects hotel inventory to HyperGuest.
...
export const derbysoftFlow = createVendorFlow({
  pmsId: DERBYSOFT_PMS_ID,
  pmsName: 'DerbySoft',
  dataFlow: 'blank',
