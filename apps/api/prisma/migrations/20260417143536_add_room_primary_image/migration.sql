...
INSERT INTO "new_HotelConfig" ("borderRadius", "childMaxAge", "colorAccent", "colorBackground", "colorBorder", "colorError", "colorPrimary", "colorPrimaryHover", "colorPrimaryLight", "colorSuccess", "colorSurface", "colorText", "colorTextMuted", "createdAt", "defaultCurrency", "defaultLocale", "displayName", "enabledCurrencies", "enabledLocales", "excludedPropertyImageIds", "excludedRoomImageIds", "fontFamily", "heroCarouselInterval", "heroImageMode", "heroImageUrl", "heroStyle", "id", "infantMaxAge", "isActive", "logoUrl", "onlinePaymentEnabled", "payAtHotelCardGuaranteeRequired", "payAtHotelEnabled", "propertyId", "roomRatesDefaultExpanded", "tagline", "textDirection", "updatedAt") SELECT "borderRadius", "childMaxAge", "colorAccent", "colorBackground", "colorBorder", "colorError", "colorPrimary", "colorPrimaryHover", "colorPrimaryLight", "colorSuccess", "colorSurface", "colorText", "colorTextMuted", "createdAt", "defaultCurrency", "defaultLocale", "displayName", "enabledCurrencies", "enabledLocales", "excludedPropertyImageIds", "excludedRoomImageIds", "fontFamily", "heroCarouselInterval", "heroImageMode", "heroImageUrl", "heroStyle", "id", "infantMaxAge", "isActive", "logoUrl", "onlinePaymentEnabled", "payAtHotelCardGuaranteeRequired", "payAtHotelEnabled", "propertyId", "roomRatesDefaultExpanded", "tagline", "textDirection", "updatedAt" FROM "HotelConfig";
