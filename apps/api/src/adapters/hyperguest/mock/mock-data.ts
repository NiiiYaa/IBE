...
export const MOCK_PROPERTY_STATIC: HGPropertyStatic = {
  ...
  facilities: [
    { id: 15, name: 'Nightclub/DJ', nameSlug: 'nightclub-dj', category: 'Electronics & Entertainment', categorySlug: 'electronics-entertainment', classification: 'Amenity', popular: 0, type: 'hotel' },
    { id: 16, name: 'Outdoor pool', nameSlug: 'outdoor-pool', category: 'Wellness', categorySlug: 'wellness', classification: 'Amenity', popular: 1, type: 'hotel' },
    { id: 17, name: 'Restaurant', nameSlug: 'restaurant', category: 'Food & Drink', categorySlug: 'food-drink', classification: 'Service', popular: 1, type: 'hotel' },
    { id: 18, name: 'Room service', nameSlug: 'room-service', category: 'Food & Drink', categorySlug: 'food-drink', classification: 'Service', popular: 0, type: 'hotel' },
    { id: 20, name: 'Free Wi-Fi', nameSlug: 'free-wi-fi', category: 'Connectivity', categorySlug: 'connectivity', classification: 'Amenity', popular: 1, type: 'hotel' },
    { id: 21, name: 'Parking', nameSlug: 'parking', category: 'Transport', categorySlug: 'transport', classification: 'Service', popular: 1, type: 'hotel' },
    { id: 22, name: 'Fitness centre', nameSlug: 'fitness-centre', category: 'Wellness', categorySlug: 'wellness', classification: 'Amenity', popular: 1, type: 'hotel' },
    { id: 23, name: 'Spa', nameSlug: 'spa', category: 'Wellness', categorySlug: 'wellness', classification: 'Service', popular: 1, type: 'hotel' },
  ],
  images: [
  ...
  rooms: [
    {
      ...
      facilities: [
        { id: 2001, name: 'Accessible by Lift', nameSlug: 'accessible-by-lift', category: 'Accessibility', categorySlug: 'accessibility', classification: 'Amenity', popular: 0, type: 'room' },
        { id: 2014, name: 'Bathroom', nameSlug: 'bathroom', category: 'Bathroom', categorySlug: 'bathroom', classification: 'Amenity', popular: 0, type: 'room' },
        { id: 2020, name: 'Air conditioning', nameSlug: 'air-conditioning', category: 'Climate', categorySlug: 'climate', classification: 'Amenity', popular: 1, type: 'room' },
        { id: 2030, name: 'Flat-screen TV', nameSlug: 'flat-screen-tv', category: 'Entertainment', categorySlug: 'entertainment', classification: 'Amenity', popular: 1, type: 'room' },
        { id: 2040, name: 'Safe', nameSlug: 'safe', category: 'General', categorySlug: 'general', classification: 'Amenity', popular: 0, type: 'room' },
      ],
      images: [
    ...
    },
    {
      ...
      facilities: [
        { id: 2020, name: 'Air conditioning', nameSlug: 'air-conditioning', category: 'Climate', categorySlug: 'climate', classification: 'Amenity', popular: 1, type: 'room' },
        { id: 2030, name: 'Flat-screen TV', nameSlug: 'flat-screen-tv', category: 'Entertainment', categorySlug: 'entertainment', classification: 'Amenity', popular: 1, type: 'room' },
        { id: 2071, name: 'Hot Tub', nameSlug: 'hot-tub', category: 'Wellness', categorySlug: 'wellness', classification: 'Amenity', popular: 0, type: 'room' },
        { id: 2050, name: 'Minibar', nameSlug: 'minibar', category: 'Food & Drink', categorySlug: 'food-drink', classification: 'Amenity', popular: 1, type: 'room' },
      ],
      images: [
