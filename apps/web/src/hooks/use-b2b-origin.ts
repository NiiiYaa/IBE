...
// Pass orgSlug to build the correct subdomain regardless of which admin subdomain you're on.
// orgSlug is the Organization.slug (e.g. "splendid-hotels"), NOT the numeric hyperGuestOrgId.
// Computing this in useEffect avoids SSR/hydration mismatches.
export function useB2bOrigin(orgSlug?: string | null): string | null {
